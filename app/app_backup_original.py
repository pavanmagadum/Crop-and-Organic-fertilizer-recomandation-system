...
if page == 'Home':
    ...
    with col1:
        ...
        """, unsafe_allow_html=True)
        if st.button("🌾 Start Prediction", key="btn_pred", use_container_width=True, type="primary"):
        ...
        """, unsafe_allow_html=True)
        if st.button("📋 View Guides", key="btn_guides", use_container_width=True, type="primary"):
            navigate_to('Preparation')
        st.markdown("</div></div>", unsafe_allow_html=True)
    ...
    with col2:
        ...
        """, unsafe_allow_html=True)
        if st.button("🍃 Convert Fertilizer", key="btn_organic", use_container_width=True, type="primary"):
            navigate_to('Preparation')
        st.markdown("</div></div>", unsafe_allow_html=True)
        ...
        """, unsafe_allow_html=True)
        if st.button("👥 Join Community", key="btn_community", use_container_width=True, type="primary"):
